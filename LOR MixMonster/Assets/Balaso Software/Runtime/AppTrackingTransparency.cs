...
namespace Balaso
{
    ...
    {   
        ...
        {
            GameUtility.GameUtility.Log(string.Format("UnityAppTrackingTransparencyCallback received: {0}", result));
        ...
        public static AuthorizationStatus TrackingAuthorizationStatus
        {
            ...
            {
#if UNITY_EDITOR
                GameUtility.GameUtility.Log("Running on Editor platform. Callback invoked with debug result");
        ...
        public static void UpdateConversionValue(int value)
        {
            ...
            {
                GameUtility.GameUtility.Log(string.Format("Updating conversion value to {0}", value));
                updateConversionValue(value);
            }
            else
            {
                GameUtility.GameUtility.Log(string.Format("Platform '{0}' not supported", Application.platform));
            }
#endif
        }
        ...
        public static void RegisterAppForAdNetworkAttribution()
        {
            ...
            if (Application.platform == RuntimePlatform.IPhonePlayer)
            {
                GameUtility.GameUtility.Log("Registering App for Ad Network Attribution");
        ...
        public static void RequestTrackingAuthorization()
        {
            ...
            if (Application.platform == RuntimePlatform.IPhonePlayer)
            {
                GameUtility.GameUtility.Log("Requesting authorization to iOS...");
        ...
        public static string IdentifierForAdvertising()
        {
            ...
            if (Application.platform == RuntimePlatform.IPhonePlayer)
            {
                GameUtility.GameUtility.Log("Obtaining IDFA from iOS...");
